...
class config {
   ...
   * Ejemplo<br>
   * MAC:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/Applications/MAMP/htdocs/DianaCrud/<br>
   * Linux:&nbsp;&nbsp;&nbsp;/var/www/DianaCrud/<br>
   * Windows:&nbsp;c:/xampp/htdocs/azucar/<br>
   * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;c:/wamp/www/DianaCrud/<br>
   * @author Diana Meneses <meneses_d@rocketmail.com>
   * @version 1.0
   * @return string
   */
   ...
   * Ejemplo<br>
   * http://localhost/DianaCrud/web/<br>
   * @author Diana Meneses <meneses_d@rocketmail.com>
   * @version 1.0
   * @return string
   */
   ...
   * MAC:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/Applications/MAMP/htdocs/DianaCrud/<br>
   * Linux:&nbsp;&nbsp;&nbsp;/var/www/DianaCrud/<br>
   * Windows:&nbsp;c:/xampp/htdocs/DianaCrud/<br>
   * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;c:/wamp/www/DianaCrud/<br>
   * @author Diana Meneses <meneses_d@rocketmail.com>
   * @version 1.0
   * @return string
